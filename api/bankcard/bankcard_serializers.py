...
class BankCardListResponseSerializer(serializers.Serializer):
    ...
    card_photo_url = serializers.CharField(help_text="银行卡照片URL")
    id_photo_badge_url = serializers.CharField(help_text="身份证国徽照片URL")
    id_photo_face_url = serializers.CharField(help_text="身份证人像照片URL")
...
class BankCardDetailResponseSerializer(serializers.Serializer):
    ...
    id_no = serializers.CharField(help_text="身份证号（隐藏中间6位）")
    mobile = serializers.CharField(help_text="预留手机号")
    card_photo = serializers.CharField(help_text="银行卡照片文件名")
    card_photo_url = serializers.CharField(help_text="银行卡照片URL")
    id_photo_badge = serializers.CharField(help_text="身份证国徽照片文件名")
    id_photo_badge_url = serializers.CharField(help_text="身份证国徽照片URL")
    id_photo_face = serializers.CharField(help_text="身份证人像照片文件名")
    id_photo_face_url = serializers.CharField(help_text="身份证人像照片URL")
    is_default = serializers.BooleanField(help_text="是否默认")
